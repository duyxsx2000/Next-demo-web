...
import { faSackDollar, faLocationDot, faPenNib,faClock } from '@fortawesome/free-solid-svg-icons'
...
export default function Job() {
    ...
    const  JobDetailsCard = function(){

        return(
            <div  className='py-4 space-y-2 text-[#414042] border-dotted border-t border-b border-[#414042]'>
                <div>
                    <FontAwesomeIcon  icon={faLocationDot} style={{color: "#8393af",}} />
                    <span className='ml-2'> Tầng 12B tòa nhà Machinco, 444 Hoàng Hoa Thám, Thụy Khuê, Tay Ho, Ha Noi</span>
                </div>
                <div>
                    <FontAwesomeIcon icon={faPenNib} style={{color: "#979ca5",}} />
                    <span className='ml-2'>At office</span>
                </div>
                <div>
                    <FontAwesomeIcon icon={faClock} style={{color: "#a8b0bd",}} />
                    <span className='ml-2'>7 hours ago</span>
                </div>
                <div className='space-x-4'>
                  
                    <span>SkillS:</span>
                    <span className=' p-1 rounded-full border-[#414042] border'>.NET</span>
                    <span className='p-1 rounded-full border-[#414042] border'>React</span>
                    <span className='p-1 rounded-full border-[#414042] border'>Python</span>
                  
                </div>
            </div>
        )
    };
    const reasonsToJoin = function(){
         return(
            <div className=' border-dotted border-b border-black py-4'>
                ...
                <ul className='ml-[20px] mt-2 space-y-2 list-disc marker:text-red-400'>
                    ...
                    <li>Liên tục được đào tạo chuyên môn, kĩ năng</li>
                    <li>Lĩnh vực chứng khoán, tài chính hấp dẫ</li>
                </ul>
            </div>
         )
    };

    const jobDescription = function(){

        return(
            <div className='border-dotted border-b border-black py-4'>
                <h1 className='font-bold text-xl'>Job description</h1>
                <p className='mt-4 text-justify'>
                 This position is responsible for serving as a technical expert; designing, developing and maintaining high profile application software and software tools for large projects and complex applications.
                 <br/>
                 This position is also responsible for adhering to and promoting GrapeCity’s vision and values by performing duties in a manner that is consistent with being a team member and supporting the continued growth of the company.
                </p>
            </div>
        )
    };

    const skillAndExperience = function(){
        ...
        return(
            <div className='border-dotted border-b border-black py-4'>
                ...
                <ul className='ml-[20px] mt-2 space-y-2 list-disc marker:text-red-400'>
                    ...
                    <li>Familiarity with Redis, Kafka</li>
                    <li>Lĩnh vực chứng khoán, tài chính hấp dẫ</li>
                    <li>Good knowledge of Data Structures and Algorithms</li>
                    <li>Experience with RESTful APIs, Microservices</li>
                    <li>Experience with Docker/Kubernetes and Cloud Infrastructure is a plus</li>
                </ul>
            </div>
        )
    };
  ...
  return (
    <div className='h-full bg-white'>
        ...
        <header className='flex flex-col justify-between px-4 h-1/5 '>
            ...
            <div className='flex  grow px-5  '>
                ...
                <div className='border-b ml-4 grow mt-5'>
                    <h1 className=' font-bold text-2xl'>[ĐN] Java (Spring) Technical Leader </h1>
                    <Link className=' text-lg text-[#414042]' href="/#">VNG Group</Link>
                    <p className='text-lg text-[#414042]'><FontAwesomeIcon icon={faSackDollar} style={{color: "#7a91b8",marginRight:"5px"}} />up to 6000 $</p>
                </div>   
            </div>
            <div className='flex justify-center items-center mb-4  bg-red-500 w-full h-8 '>
                <Link className='text-center w-full  text-white' href="/#">Apply Now</Link>
        ...
        <main className='px-5 h-4/5 space-y-3   p-4 overflow-auto   '>
            ...
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
            Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc và rõ nghĩa dễ gây rối trí và cản trở việc tập trung vào yếu tố trình bày văn bản. Lorem Ipsum có ưu điểm hơn so với đoạn văn bản chỉ gồm nội dung kiểu "Nội dung, nội dung, nội dung" là nó khiến văn bản giống thật hơn, bình thường hơn. Nhiều phần mềm thiết kế giao diện web và dàn trang ngày nay đã sử dụng Lorem Ipsum làm đoạn văn bản giả, và nếu bạn thử tìm các đoạn "Lorem ipsum" trên mạng thì sẽ khám phá ra nhiều trang web hiện vẫn đang trong quá trình xây dựng. Có nhiều phiên bản khác nhau đã xuất hiện, đôi khi do vô tình, nhiều khi do cố ý (xen thêm vào những câu hài hước hay thông tục).
